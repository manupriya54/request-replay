...
| Java (JVM) | [HttpURLConnection](http://download.java.net/jdk7/archive/b123/docs/api/java/net/HttpURLConnection.html) | [Jackson](http://wiki.fasterxml.com/JacksonHome) |
